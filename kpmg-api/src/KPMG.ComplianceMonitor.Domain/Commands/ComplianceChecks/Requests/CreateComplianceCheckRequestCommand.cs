...
public class CreateComplianceCheckRequestCommand : ComplianceCheckCommand
{
    public CreateComplianceCheckRequestCommand(EnumComplianceType? complianceType,
    ...
    {
        ValidationResult = new CreateComplianceCheckRequestCommandValidation().Validate(this);
